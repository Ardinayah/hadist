...
<?php echo form_open(base_url('admin/riwayat/edit/'.$riwayat['riwayat_id']),' class="form-horizontal"') ?>

<input type="hidden" name="riwayat_id" value="<?php echo $riwayat['riwayat_id'] ?>">

<div class="form-group row">
  <label class="col-sm-3 control-label text-right">Riwayat<span class="text-danger">*</span></label>
  <div class="col-sm-9">
        <input type="text" name="riwayat" id="riwayat" class="form-control" placeholder="Riwayat" value="<?php echo $riwayat['riwayat'] ?>">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <input type="text" name="riwayat_desc" class="form-control" placeholder="Deskripsi" value="<?php echo $riwayat['riwayat_desc'] ?>">
  </div>
</div>
